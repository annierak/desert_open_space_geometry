...
def main(puff_spread_rate_factor):
    ...
    plt.axis('off')
    ax.text(0,1.7,'Trap Counts'+' (Spread Rate Factor: '+str(puff_spread_rate_factor)+')',horizontalalignment='center',verticalalignment='center',fontsize=20)
